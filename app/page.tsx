...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      >
        <div className="w-full max-w-6xl mx-auto px-6 mt-40 text-center">
          <h1 className="text-6xl md:text-7xl font-bold mb-6 leading-tight">
            Design That <span className="text-blue-400">Drives</span> Action
          </h1>
          <p className="text-xl md:text-2xl mb-8 max-w-3xl mx-auto leading-relaxed">
            I'm Harsh Suthar, transforming raw ideas into compelling digital
            stories through strategic design that doesn't just look good — it
            works hard.
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white p-8 rounded-2xl shadow-lg hover:shadow-xl transition-shadow">
              ...
              <p className="text-gray-600 leading-relaxed">
                Thumbnails that don't just catch the eye — they command clicks.
                Strategic visual storytelling that turns browsers into viewers.
              </p>
            </div>
            ...
            <div className="bg-white p-8 rounded-2xl shadow-lg hover:shadow-xl transition-shadow">
              ...
              <p className="text-gray-600 leading-relaxed">
                Converting scrollers into followers through designs that stop
                thumbs mid-scroll and spark engagement.
              </p>
            </div>
            ...
            <div className="bg-white p-8 rounded-2xl shadow-lg hover:shadow-xl transition-shadow">
              ...
              <p className="text-gray-600 leading-relaxed">
                From eco-conscious EcoVibes Daily to sleek BlueprintBay
                corporates — brands that resonate and remember.
              </p>
            </div>
          </div>
        </div>
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-black/70 to-transparent flex items-end">
                <div className="p-6 text-white">
                  ...
                  <p className="text-gray-200">
                    Eco-conscious brand identity that speaks sustainability
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="group relative overflow-hidden rounded-2xl">
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-black/70 to-transparent flex items-end">
                <div className="p-6 text-white">
                  ...
                  <p className="text-gray-200">
                    Sleek corporate visuals that command authority
                  </p>
                </div>
              </div>
            </div>
      ...
      <section className="py-20 bg-gray-900 text-white">
        <div className="max-w-6xl mx-auto px-6 text-center">
          <h2 className="text-4xl md:text-5xl font-bold mb-8">
            Beyond Pixels, It's About{" "}
            <span className="text-blue-400">Energy</span>
          </h2>
          <p className="text-xl md:text-2xl leading-relaxed mb-8">
            Great design isn't decoration — it's strategy, it's identity, it's
            power. Every project I create bridges bold creativity with strategic
            thinking, understanding what makes people click, care, and remember.
          </p>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-16">
            <div className="text-center">
              ...
              <p className="text-gray-300">
                Every design decision is backed by purpose and psychology
              </p>
            </div>
            <div className="text-center">
              ...
              <p className="text-gray-300">
                Creating memorable experiences through powerful visual
                storytelling
              </p>
            </div>
            <div className="text-center">
              ...
              <p className="text-gray-300">
                Designs that don't just look good — they convert and perform
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-20 bg-blue-600">
        <div className="max-w-4xl mx-auto px-6 text-center text-white">
          ...
          <p className="text-xl mb-8">
            Let's create something extraordinary together. Because your brand
            deserves design that works as hard as you do.
          </p>
          <Link
            href="/contact"
